...
public class PostUsersTests : TestBase
{
    ...
    {
        var newUser = UserGenerator.GenerateUserWithEmptyName();
    ...
    {
        var newUser = UserGenerator.GenerateUserWithInvalidGender();
    ...
    {
        var newUser = UserGenerator.GenerateUserWithInvalidEmail();
